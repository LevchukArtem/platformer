...
class Saw(Object):
    ...
    def on(self, cell_size, n, n_1):
        if self.rect.x <= cell_size * n:
            self.side = "right"
        if self.rect.x >= cell_size*n_1:
            self.side = "left"
        if self.side == "left":
...
blocks.add(
    [Block("tiles","Grass.png",i*block_size,screen_H-block_size,block_size) for i in range(5)],
        [Block("tiles","Grass.png",i*block_size,8*block_size,block_size) for i in range(7,10)],
         [Block("tiles","Grass.png",i*block_size,5*block_size,block_size) for i in range(1,10)],
          [Block("tiles","Grass.png",i*block_size,2*block_size,block_size) for i in range(8,13)],
        [Block("tiles","Dirt.png",i*block_size,3*block_size,block_size) for i in range(12,13)],
        [Block("tiles","Dirt.png",i*block_size,4*block_size,block_size) for i in range(12,13)],
        [Block("tiles","Dirt.png",i*block_size,5*block_size,block_size) for i in range(12,13)],
        [Block("tiles","Dirt.png",i*block_size,6*block_size,block_size) for i in range(12,13)],
        [Block("tiles","Dirt.png",i*block_size,7*block_size,block_size) for i in range(12,13)],
        [Block("tiles","Dirt.png",i*block_size,8*block_size,block_size) for i in range(12,13)],
         [Block("tiles","Grass.png",i*block_size,9*block_size,block_size) for i in range(13,14)],
)

saws.add(Saw("traps", "Saw.png", block_size * 1, block_size * 3, block_size * 2))

door = Door("tiles", "door.png", block_size * 13, block_size * 7, block_size, block_size * 2)
